...
Use `--spine-width 1.45` to set the frame thickness explicitly; the default is `1.45 pt`.
...
- Keep the complete axes frame visible and set its default spine width around `1.45 pt`, using dark neutral axes color. Make marker edges around `1.35 pt` to match the stronger frame without overpowering the lines; preserve config overrides.
